...
const ParticleIcon = memo(({ icon: Icon, delay, position }: { 
...
export const metadata = {
  ...
  description: 'Analyze engineering requirements against regulatory documents with advanced AI.'
}
...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 transition-colors duration-200 relative overflow-hidden">
      ...
      {mountIcons && icons.map((Icon, index) => (
        <ParticleIcon 
          key={index} 
          icon={Icon} 
          delay={index * 0.5} 
