        ...
        <div className="space-y-6">
          <div>
            <h2 className="text-2xl font-bold">
              Create New {showTabs.charAt(0).toUpperCase() + showTabs.slice(1)}
            </h2>
          ...
          {showTabs === "requirement" && (
            <RequirementForm projectId={projectId} onSuccess={handleClose} />
          )}
          {showTabs === "collection" && (
            <CollectionForm onSuccess={handleClose} />
          )}
          {showTabs === "document" && (
            <DocumentForm collectionId={collectionId} onSuccess={handleClose} />
          )}
        </div>
      </SidePanel>
    );
      ...
      <div className="space-y-6">
        ...
        <Tabs
          ...
          onValueChange={(value: string) =>
            setActiveTab(
              value as "project" | "requirement" | "collection" | "document",
            )
          }
        >
