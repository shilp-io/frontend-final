...
import { ProjectItem, ProjectPanel, TableManager, CreatePanel } from "@/components/private";
...
export default function ProjectsPage() {
	...
	const columns: Column<Project>[] = [
		...
		{
			header: "Timeline",
			accessor: (project: Project) => `${formatDate(project.start_date)} - ${formatDate(project.target_end_date)}`,
			width: 40,
			isSortable: true
		}
	];
